 ...
 */
void
IpMessengerAgentImpl::SendPacket( char *buf, int size, struct sockaddr_in to_addr )
{
#if defined(DEBUG)
	printf("== S E N D ============================================>\n");
 ...
 */
void
IpMessengerAgentImpl::SendBroadcast( char *buf, int size )
{
#if defined(DEBUG)
 ...
 */
string
IpMessengerAgentImpl::GetCommandString(long cmd )
{
	switch( cmd ){
